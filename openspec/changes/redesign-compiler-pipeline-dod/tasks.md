...
- [ ] 1.2 Define formalized 32-bit metadata encoding (bits 0-7: kind, 8-13: size, 14-19: arg count, 20: terminator, 21: diagnostic, 22-31: reserved)
- [ ] 1.3 Implement slab iteration utilities for reading self-describing instruction blocks
