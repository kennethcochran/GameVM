...
# Setup substitutions
script_dir = os.path.abspath(os.path.join(config.test_source_root, '..', 'scripts'))
filecheck_py = os.path.join(script_dir, 'filecheck.py')
bincheck_sh = os.path.join(script_dir, 'bincheck.sh')
...
compile_project_bin = os.path.join(project_root, 'src', 'GameVM.Compile', 'bin', 'Debug', 'net8.0')
compiler_dll = os.path.join(compile_project_bin, 'GameVM.Compile.dll')
...
dev_tool_dll = os.path.join(project_root, 'src', 'GameVM.DevTools', 'bin', 'Debug', 'net8.0', 'GameVM.DevTools.dll')
dev_tool = f"dotnet {dev_tool_dll}"
monitor_lua = os.path.join(script_dir, 'monitor.lua')
